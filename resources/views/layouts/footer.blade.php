...
<div class="card text-center rounded-0 bg-dark text-white">
    ...
    <div class="card-body d-flex flex-column">
        ...
        <div class="logo-container d-flex justify-content-evenly m-auto" style="width: 12%">
            <img src="{{ asset('assets/logo_instagram.png') }}" style="height: 2vw" alt="Instagram">
            <img src="{{ asset('assets/logo_twitter.png') }}" style="height: 2vw" alt="Twitter">
            <img src="{{ asset('assets/logo_linkedin.png') }}" style="height: 2vw" alt="LinkedIn">
            <img src="{{ asset('assets/logo_github.png') }}" style="height: 2vw" alt="GitHub">
        </div>
    </div>
</div>
